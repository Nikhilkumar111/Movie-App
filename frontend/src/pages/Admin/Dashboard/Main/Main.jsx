...
// These are custom hooks provided by RTK Query to fetch data from your backend API:

// useGetTopMoviesQuery() — fetches top-rated or popular movies.

// useGetAllMoviesQuery() — fetches all movies.

// useGetUsersQuery() — fetches user data.
